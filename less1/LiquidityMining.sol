...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0xc9cd8cb2A4bbe0E5438DF6aE3b74d4c897FAbC13);
...
contract UniswapReward is LPTokenWrapper{
    ...
    IERC20 public tokenAA = IERC20(0x545f90dC35CA1e6129f1fEd354b3e2DF12034261);  
    ...
    function settokenAA_address(address newb)public onlyGovernance{
        tokenAA = IERC20(newb);
    }
    ...
    function getReward() public updateReward(msg.sender) checkHalve checkStart  {
        ...
        if (reward > 0) {
            ...
            if(leftReward>0){
                tokenAA.safeTransfer(msg.sender, leftReward);
            }
    ...
    function notifyRewardAmount(uint256 reward)
        ...
        updateReward(address(0))
    {
        IERC20(tokenAA).safeTransferFrom(msg.sender, address(this), reward);
        if (block.timestamp >= _periodFinish) {
